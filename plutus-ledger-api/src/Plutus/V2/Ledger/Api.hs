...
langV2 :: LanguageVersion
langV2 = PLC.Version () 2 0 0
...
isScriptWellFormed = Common.isScriptWellFormed langV2
...
evaluateScriptCounting = Common.evaluateScriptCounting langV2
...
evaluateScriptRestricting
    ...
    -> [PLC.Data]          -- ^ The arguments to the script
    -> (LogOutput, Either EvaluationError ExBudget)
evaluateScriptRestricting = Common.evaluateScriptRestricting langV2
