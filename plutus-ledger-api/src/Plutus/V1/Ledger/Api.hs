...
langV1 :: LanguageVersion
langV1 = PLC.Version () 1 0 0
...
isScriptWellFormed = Common.isScriptWellFormed langV1
...
evaluateScriptCounting = Common.evaluateScriptCounting langV1
...
evaluateScriptRestricting
    ...
    -> [PLC.Data]          -- ^ The arguments to the script
    -> (LogOutput, Either EvaluationError ExBudget)
evaluateScriptRestricting = Common.evaluateScriptRestricting langV1
